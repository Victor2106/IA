...
const { addQueue, getRadio, getQueue } = require("../utils/playerManager");

module.exports = class Playsc extends Command {
	constructor() {
		super({
			name: "playsc",
			category: "music",
			aliases: [],
			description: "The command plays SoundCloud music",
			usage: "{{prefix}}playsc <Music Title>",
			cooldown: 10000
		});
	}
